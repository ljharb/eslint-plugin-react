...
module.exports = {
  ...
  create(context) {
    ...
    function getFixerToLong(jsxFragment) {
      ...
      return /** @param {Parameters<typeof import('eslint').Rule.Fixer>} fixer */ (function fix(fixer) {

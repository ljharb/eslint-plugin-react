...
module.exports = {
  ...
  create(context) {
    ...
    /**
     * Get properties name
     * @param {ClassProperty | PropertyDefinition | MemberExpression} node - Property.
     ...
     * @param {ClassProperty | PropertyDefinition | MemberExpression} node The node to check. Must be an Identifier node.

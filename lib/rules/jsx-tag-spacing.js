...
/** @type {(context: Context, node: JSXOpeningElement | JSXClosingElement, option: unknown) => void} */
...
/** @type {(context: Context, node: JSXOpeningElement | JSXClosingElement, option: 'always' | 'proportional-always' | 'never' | 'allow') => void} */
...
/** @type {(context: Context, node: JSXOpeningElement | JSXClosingElement, option: 'always' | 'allow-multiline' | 'never' | 'allow') => void} */
...
const optionDefaults = /** @type {const} */ ({
  closingSlash: 'never',

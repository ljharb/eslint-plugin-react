...
/** @param {Parameter[] | Pattern[]} params */
...
module.exports = {
  ...
  create: Components.detect((context, components, utils) => {
    ...
    /** @type {(node: FunctionDeclaration | ArrowFunctionExpression | FunctionExpression) => void} */
    ...
    function handleClassUsage(node) {
      ...
      const isPropUsed = (
        ...
        && isThisExpression(node.object.object)
    ...
    return {
      ...
      VariableDeclarator(node) {
        ...
        const destructuringClass = destructuring
          && node.init
          && 'object' in node.init
          && isThisExpression(node.init.object)
          && 'name' in node.init.property
          && (

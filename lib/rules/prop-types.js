...
module.exports = {
  ...
  create: Components.detect((context, components) => {
     ...
     * @param {import('../util/Components').Component['declaredPropTypes']} declaredPropTypes Description of propTypes declared in the current component
    ...
    return {
      'Program:exit'() {
        ...
        values
          ...
          .forEach((component) => {
            if (checkNestedComponent(component, values)) return;

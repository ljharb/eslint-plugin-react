...
const uncast = astUtil.uncast;
const isThisExpression = astUtil.isThisExpression;
const isMemberExpression = astUtil.isMemberExpression;
...
function isSetStateCall(node) {
  ...
  return (
    astUtil.isMemberExpression(unwrappedCalleeNode)
      ...
      'PropertyDefinition, ClassProperty'(node) {
        ...
        if (argVar) {
          ...
          stateRefs.forEach((ref) => {
            ...
            if (identifier && identifier.parent && isMemberExpression(identifier.parent)) {

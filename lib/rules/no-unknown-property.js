...
const DOM_ATTRIBUTE_NAMES = /** @type {const} */ ({
...
const ATTRIBUTE_TAGS_MAP = /** @type {const} */ ({
  abbr: ['th', 'td'],
  charset: ['meta'],
  checked: ['input'],
...
const SVGDOM_ATTRIBUTE_NAMES = /** @type {const} */ ({
...
const DOM_PROPERTY_NAMES_ONE_WORD = /** @type {const} */ ([
...
const DOM_PROPERTY_NAMES_TWO_WORDS = /** @type {const} */ ([
  // Global attributes - can be used on any HTML/DOM element
  // See https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes
...
const DOM_PROPERTIES_IGNORE_CASE = /** @type {const} */ (['charset', 'allowFullScreen', 'webkitAllowFullScreen', 'mozAllowFullScreen', 'webkitDirectory', 'popoverTarget', 'popoverTargetAction']);

const ARIA_PROPERTIES = /** @type {const} */ ([
...
const REACT_ON_PROPS = /** @type {const} */ ([
  'onGotPointerCapture',
...
function getDOMPropertyNames(context) {
  return /** @type {(typeof DOM_PROPERTY_NAMES_TWO_WORDS | DOM_PROPERTY_NAMES_ONE_WORD | REACT_ON_PROPS)[]} */ ([].concat(
...
function getTagName(node) {
  if (
    ...
    && 'name' in node.parent
    && node.parent.name
    && typeof node.parent.name !== 'string'
...
function getStandardName(name, context) {
  ...
  return names.find((element) => /** @type {Lowercase<typeof element>} */ (element.toLowerCase()) === name.toLowerCase());
}

...
/** @typedef {{ fullName: string, name: string, isRequired: boolean, node?: ASTNode }} DeclaredPropType */
/** @typedef {Record<string, DeclaredPropType>} DeclaredPropTypeMap */
/** @typedef {[string, ASTNode]} DefaultProp */
/** @typedef {Record<string, DefaultProp>} DefaultPropMap */
/** @typedef {{ node: ASTNode, confidence: number, usedPropTypes?: Prop[], hasDisplayName?: boolean, hasSCU?: boolean, setStateUsages?: (MemberExpressionComputedName | MemberExpressionNonComputedName)[], useSetState?: boolean, ignoreUnusedPropTypesValidation?: boolean, declaredPropTypes?: DeclaredPropTypeMap, useThis?: boolean, useRef?: boolean, invalidReturn?: boolean, hasChildContextTypes?: boolean, useDecorators?: boolean, defaultProps?: 'unresolved' | DefaultPropMap, invalidProps?: (ObjectLiteralElement | RestElement)[] } } Component */
...
/** @typedef {{ isDestructuredFromPragmaImport: (node: ASTNode, variable: string) => boolean, isReturningJSX: (node: ASTNode, strict?: boolean) => boolean, isReturningJSXOrNull: (node: ASTNode, strict?: boolean) => boolean, isReturningOnlyNull: (node: ASTNode) => boolean, isPragmaComponentWrapper: (node: ASTNode) => boolean, getPragmaComponentWrapper: (node: ASTNode) => ASTNode, getComponentNameFromJSXElement: (node: Expression) => null | string, getNameOfWrappedComponent: (node: undefined | CallExpressionArgument[]) => string | null, getDetectedComponents: () => (string | boolean)[], nodeWrapsComponent: (node: ASTNode) => boolean, findReturnStatement: typeof findReturnStatement, getParentComponent: (node: ASTNode) => ASTNode, isInAllowedPositionForComponent: (node: ASTNode) => boolean, getStatelessComponent: (node: ASTNode) => undefined | ASTNode, getParentStatelessComponent: (node: ASTNode) => null | ASTNode, getRelatedComponent: (node: ASTNode) => null | Component, isParentComponentNotStatelessComponent: (node: ASTNode) => boolean, isReactHookCall: (node: ASTNode, expectedHookNames?: HookNames[]) => boolean }} Utils */

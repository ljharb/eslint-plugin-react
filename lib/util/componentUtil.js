...
const isMemberExpression = require('./ast').isMemberExpression;
const isThisExpression = require('./ast').isThisExpression;
...
const getPragma = memoize(getFromContext);
const getCreateClass = memoize(getCreateClassFromContext);
 ...
 * @returns {boolean}
 */
function isES5Component({ parent }, context) {

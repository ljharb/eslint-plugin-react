 ...
 * @param {Variable[]} variables The variables list.
 ...
 * @param {Variable[]} variables The variables list.
 * @param {string} name The name of the variable to search.
 * @returns {Variable | undefined} Variable if the variable was found, undefined if not.
 */
 ...
 * @returns {Definition | undefined} The latest variable definition or undefined.
 */

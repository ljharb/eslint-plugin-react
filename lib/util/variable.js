...
const { isImportBinding, isTypeAlias } = require('./ast');
 ...
 * @param {import('eslint').Scope.Variable[]} variables The variables list.
 * @param {string} name The name of the variable to search.
 * @returns {import('eslint').Scope.Variable} Variable if the variable was found, null if not.
 */
 ...
 *
 * @param {Context} context The current rule context.
 * @param {ASTNode} node The node to start looking from.
 * @param {string} name The name of the variable to search.
 * @returns {import('eslint').Scope.Variable | undefined} Variable if the variable was found, undefined if not.
 */
